...
const SurveyForm = () => {
  ...
  const handleGeneratePdf = () => {
    ...
    html2canvas(input, { allowTaint: true, useCORS: true }).then((canvas) => {
      ...
      const firstPageWidth =
        (firstPageHeight * imgProps.width) / imgProps.height;
  ...
  const handleDelete = (target_value) => {
    // Split the target_value to get the path keys
    const keys = target_value.split('.');
  
    // Make a shallow copy of formik.values
    let values = { ...formik.values };
  
    // Use a reference to traverse the nested structure
    let ref = values;
    for (let i = 0; i < keys.length - 1; i++) {
      ref = ref[keys[i]] = Array.isArray(ref[keys[i]]) ? [...ref[keys[i]]] : { ...ref[keys[i]] };
    }
  
    // The last key to update the array
    const lastKey = keys[keys.length - 1];
  
    // Perform the delete operation (e.g., remove the last element if the array length is greater than 1)
    if (Array.isArray(ref[lastKey]) && ref[lastKey].length > 1) {
      ref[lastKey] = ref[lastKey].slice(0, -1);
    }
  
    // Set the new state with formik.setFieldValue
    formik.setFieldValue(keys[0], values[keys[0]]);
    ...
    <div className="w-full md:w-[650px] md:p-2 mx-auto">
      <div>
        <form
          ...
          className="flex flex-col gap-y-5 my-2"
        >
          ...
          <div className="p-6 flex flex-col gap-y-5 md:border border-gray-200 rounded-md md:shadow-md">
                ...
                <div className="flex flex-col gap-y-5 my-3" key={index}>
                  ...
                  <div className="flex flex-col gap-y-1">
                    ...
                    <Input
                      ...
                      type="text"
                      name={`workExperience[${index}].startedDate`}
                      onChange={formik.handleChange}
                      value={experience.startedDate}
                    />
                  </div>
                  <div className="flex flex-col gap-y-1">
                  ...
                  <div className="flex flex-col gap-y-1">
                    ...
                    <Input
                      ...
                      type="text"
                      name={`workExperience[${index}].keyAchievements`}
                      onChange={formik.handleChange}
            ...
            <Button
                  ...
                  size="sm"
                  type="button"
                  className="w-[42px] h-[42px]  hover:bg-red-500 "
            ...
            {formik.values.projects?.map((project, index) => (
              <div className="flex flex-col gap-y-5" key={index}>
                ...
                <div className="flex flex-col gap-y-1">
                  ...
                  <Input
                    id={`githubRepoLink-${index}`}
                    type="text"
                    name={`projects[${index}].githubRepoLink`}
                    onChange={formik.handleChange}
          ...
          <div className="p-6 flex flex-col gap-y-5 md:border border-gray-200 rounded-md md:shadow-md">
            ...
            <div className="p-2 flex flex-col gap-y-5 border-b border-gray-200 pb-4">
              ...
              {formik.values.skills?.backendLanguages.map((skill, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row w-full items-start md:items-center md:justify-between"
                >
              ...
              <div className="flex gap-x-2 items-center justify-between w-[150px] ">
                <Button
                  variant="default"
                  size="sm"
                  type="button"
                  className="w-[100px] ml-2"
                  onClick={addBackendSkill}
                >
                  + Add
                </Button>
                <Button
                  ...
                  size="sm"
                  type="button"
                  className="w-[42px] h-[36px]  hover:bg-red-500 "
                  onClick={() => handleDelete('skills.backendLanguages')}
                >
                  <Image
                    src={"/delete.png"}
                    width={32}
            ...
            <div className="p-2 flex flex-col gap-y-5  border-b border-gray-200 pb-4">
              ...
              <div className="flex gap-x-2 items-center justify-between w-[150px] ">
                ...
                <Button
                  ...
                  type="button"
                  className="w-[42px] h-[36px]  hover:bg-red-500 "
                  onClick={() => handleDelete('skills.frontendLanguages')}
                >
                  <Image
                    src={"/delete.png"}
                    width={32}
            ...
            <div className="p-2 flex flex-col gap-y-5 border-b border-gray-200 pb-4">
              ...
              <div className="flex gap-x-2 items-center justify-between w-[150px] ">
                ...
                <Button
                  ...
                  type="button"
                  className="w-[42px] h-[36px]  hover:bg-red-500 "
                  onClick={() => handleDelete('skills.databases')}
                >
                  <Image
                    src={"/delete.png"}
                    width={32}
            ...
            <div className="p-2 flex flex-col gap-y-5 border-b border-gray-200 pb-4">
              ...
              <div className="flex gap-x-2 items-center justify-between w-[150px] ">
                ...
                <Button
                  ...
                  type="button"
                  className="w-[42px] h-[36px]  hover:bg-red-500 "
                  onClick={() => handleDelete('skills.cloudTechnologies')}
                >
                  <Image
                    src={"/delete.png"}
                    width={32}
            ...
            <div className="p-2 flex flex-col gap-y-5 border-b border-gray-200 pb-4">
              ...
              <div className="flex gap-x-2 items-center justify-between w-[150px] ">
                ...
                <Button
                  ...
                  type="button"
                  className="w-[42px] h-[36px]  hover:bg-red-500 "
                  onClick={() => handleDelete('skills.softSkills')}
                >
                  <Image
                    src={"/delete.png"}
                    width={32}
          ...
          <div className="p-6 flex flex-col gap-y-5 md:border border-gray-200 rounded-md md:shadow-md">
            ...
            <div className="flex flex-col gap-y-1">
              ...
              <Input
                id="awardsAndRecognition"
                type="text"
                name="awardsAndRecognition"
                onChange={formik.handleChange}
                value={formik.values.awardsAndRecognition}
              />
            </div>
            <div className="flex flex-col gap-y-1">
            ...
            <div className="flex flex-col gap-y-1">
              ...
              <Input
                ...
                name="volunteerWork"
                onChange={formik.handleChange}
                value={formik.values.volunteerWork}
              />
            </div>
            <div className="flex flex-col gap-y-1">
              <Label>Foreign Languages Spoken</Label>
              <Input
                id="foreignLanguagesSpoken"
                type="text"
                name="foreignLanguagesSpoken"
                onChange={formik.handleChange}
                value={formik.values.foreignLanguagesSpoken}
              />
            </div>
            <div className="flex flex-col gap-y-1">
